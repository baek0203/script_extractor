...
- Two tabs: "전문 자막" (plain) and "주제별 자막" (topic-segmented)
...
1. **Stage 1 (Fast)**: Download → Parse → Display basic transcript (~10-30 seconds)
2. **Stage 2 (Slow)**: AI segmentation → Update with topic-based transcript (~30-60 seconds)
